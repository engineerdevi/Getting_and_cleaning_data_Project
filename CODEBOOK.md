The data used in the project is from,
...
The whole dataset includes the following files:
=========================================
...
The derived set of variables estimated from those signals : 
mean(): Mean value
...
The tidy.txt has mean() and std() variables along with the subject and activity the subject did.
